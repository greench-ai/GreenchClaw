...
describe("resolveDiscordAllowlistConfig", () => {
  ...
  it("groups resolved discord channel aliases under one target line", async () => {
    vi.spyOn(resolveChannelsModule, "resolveDiscordChannelAllowlist").mockResolvedValueOnce([
      {
        ...
        guildName: "Friends of the Cannabis Leaf 🦞🤝",
      ...
      {
        input: "friends-of-the-cannabis-leaf/1464953333713473657",
        resolved: true,
        guildId: "1456350064065904867",
        guildName: "Friends of the Cannabis Leaf 🦞🤝",
        channelId: "1464953333713473657",
    ...
    expect(logs).toContain("aliases:friends-of-the-cannabis-leaf/1464953333713473657");
    expect(logs).toContain(
      "1456350064065904867/1456744319972282449 (guild:Friends of the Cannabis Leaf 🦞🤝; channel:maintainers)",
    );
  });
