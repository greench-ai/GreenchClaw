...
// M3 advertises a 1M-token context window upstream. Until MiniMax publishes a
// dedicated M3 price tier, the M3 cost tier mirrors M2.7's API pricing; the
// cost object is a separate export so it can be tuned without changing M2.7.
export const MINIMAX_M3_CONTEXT_WINDOW = 1_000_000;
export const MINIMAX_M3_MAX_TOKENS = 64_000;
...
// M3 cost tier — matches M2.7 input/output rates until MiniMax publishes a
// dedicated M3 price tier.
