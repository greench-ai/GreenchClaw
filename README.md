...
[![CI status](https://img.shields.io/github/actions/workflow/status/greench-ai/GreenchClaw/ci.yml?branch=main&style=for-the-badge)](https://github.com/greench-ai/GreenchClaw/actions)
[![GitHub release](https://img.shields.io/github/v/release/greench-ai/GreenchClaw?include_prereleases&style=for-the-badge)](https://github.com/greench-ai/GreenchClaw/releases)
[![Discord](https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge)](https://discord.gg/clawd)
...
Sponsored by [OpenAI](https://openai.com/) · [GitHub](https://github.com/) · [NVIDIA](https://www.nvidia.com/) · [Vercel](https://vercel.com/) · [Blacksmith](https://blacksmith.sh/) · [Convex](https://www.convex.dev/)
...
- **[Memory System v2](https://docs.GreenchClaw.ai/concepts/memory)** — Mem0-inspired persistent memory with hybrid FTS5 + semantic (OpenRouter) search. Agents can extract, store, and recall factual memories across sessions using `evoclaw/tools/memory_pipeline.py`.
...
- **Memory System v2** (EvoClaw agents): `evoclaw/tools/memory_pipeline.py` — persistent fact extraction + hybrid search. Uses OpenRouter free embeddings (text-embedding-3-small, 1536 dims) + SQLite FTS5. Run `python3 evoclaw/tools/memory_pipeline.py --help` for usage.
...
[![Star History Chart](https://api.star-history.com/svg?repos=greench-ai/GreenchClaw&type=date&legend=top-left)](https://www.star-history.com/#greench-ai/GreenchClaw&type=date&legend=top-left)

## About

**GreenchClaw** is a fork of [OpenClaw](https://github.com/steipete/OpenClaw) maintained by [Greench](https://github.com/greench-ai). 🦞

Built for the [Greench-AI](https://greench-ai.net) multi-agent lab — a personal AI assistant that runs on your own devices, answers on the channels you already use, and evolves through the EvoClaw self-improvement framework.
